        ...
        <section className="input-container">
          ...
          <div className="custom-input">
            <form>
              ...
              <TextField hintText="Username" floatingLabelText="Instagram Username" value={props.InstaUser} onChange={props.handleInsta}/><br/>
              <label>Email Address</label>
              <TextField hintText="Email" floatingLabelText="Email" value={props.Email} onChange={props.handleEmail}/><br/>
            </form>
